...
public class Silly implements Comparable<Silly>{
    ...
    /**
     * Creates a new Silly object.
     * This constructor takes in two Strings (first, and second) as arguments.
     *
     * @param first first word of this Silly instance's name.
     * @param second second word of this Silly instance's name.
     */
